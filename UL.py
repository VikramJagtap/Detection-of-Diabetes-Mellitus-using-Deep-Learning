...
label_l1 = tk.Label(root, text=" Ulcer With Remedy",font=("Times New Roman", 30, 'bold'),
...
lbluser=tk.Label(Login_frame,text=" || Remedies and Further Steps || \n 1. washing your feet every day. \n\n 2.keeping toenails adequately trimmed, but not too short.\n\n 3.keeping your feet dry and moisturized. \n\n 4. changing your socks frequently .\n\n 5.seeing a podiatrist for corn and callus removal.",font=("Times new roman", 20, "bold"),bg="white").grid(row=1,column=0,padx=0,pady=10)
