...
#    global fn
    ...
    if fn!="":
        ...
        if index == 0:
            Cd="Control Group"
            button4 = tk.Button(root, text="CM Remedy",command=m1,width=15, height=1,bg="red",fg="black", font=('times', 15, ' bold '))
            button4.place(x=550, y=650)    
        
        else:
            Cd="DM Group"
            button4 = tk.Button(root, text="DM Remedy",command=m2,width=15, height=1,bg="red",fg="black", font=('times', 15, ' bold '))
            button4.place(x=550, y=650)  
